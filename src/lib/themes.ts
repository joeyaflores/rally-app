...
export const THEMES: Record<SessionTheme, ThemeConfig> = {
  navy: { bg: "bg-navy-dark", hex: "#1d5c14", circle1: "bg-white/[0.03]", circle2: "bg-white/[0.02]", label: "forest" },
  green: { bg: "bg-[#29741d]", hex: "#29741d", circle1: "bg-white/[0.04]", circle2: "bg-white/[0.03]", label: "green" },
